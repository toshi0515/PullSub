...
{
    internal readonly struct QueueHandlerDebugSnapshot
    {
        public QueueHandlerDebugSnapshot(int activeCount, int faultedCount, DateTime lastFaultUtc)
        {
    ...
    internal static class PullSubQueueHandlerDebugTracker
    {
        ...
        public static QueueHandlerDebugSnapshot GetSnapshot(PullSubRuntime runtime, string topic)
        {
#if UNITY_EDITOR
            ...
            lock (Gate)
            {
                ...
                return new QueueHandlerDebugSnapshot(
                    state.ActiveCount,
                    state.FaultedCount,
                    state.LastFaultUtc);
            }
