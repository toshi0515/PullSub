...
{
    internal readonly struct PendingRequestRegistration
    {
        public PendingRequestRegistration(
    ...
    internal readonly struct PendingRequestStoreDebugSnapshot
    {
        public PendingRequestStoreDebugSnapshot(
            int pendingCount,
    ...
    internal sealed class PendingRequestStore
    {
        ...
        public PendingRequestStore(int maxPendingRequests, Action<int> onPendingCountChanged)
        {
        ...
        public PendingRequestRegistration Register(
            string correlationId,
            ...
            CancellationToken callerToken)
        {
            ...
            return new PendingRequestRegistration(correlationId, completion.Task);
        }
        ...
        public PendingRequestStoreDebugSnapshot GetDebugSnapshot(bool isReplyInboxSubscribed)
        {
            lock (_gate)
            {
                return new PendingRequestStoreDebugSnapshot(
