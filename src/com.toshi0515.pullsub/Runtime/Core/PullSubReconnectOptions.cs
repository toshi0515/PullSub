...
{
    public sealed class PullSubReconnectOptions : IEquatable<PullSubReconnectOptions>
    {
        public static PullSubReconnectOptions Default { get; }
            = new PullSubReconnectOptions(
                initialDelay: TimeSpan.FromSeconds(1),
                maxDelay: TimeSpan.FromSeconds(60),
                multiplier: 2.0,
                jitterFactor: 0.2);

        public PullSubReconnectOptions(
        ...
        public static PullSubReconnectOptions FromInitialDelaySeconds(int reconnectDelaySeconds)
        {
            ...
            return new PullSubReconnectOptions(initial, max, multiplier: 2.0, jitterFactor: 0.2);
        }

        public bool Equals(PullSubReconnectOptions other)
        {
        ...
        public override bool Equals(object obj) => Equals(obj as PullSubReconnectOptions);
