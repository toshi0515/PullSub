...
{
    public static class PullSubDiagnosticsLogExtensions
    {
            ...
            int maxTopics = 128)
        {
            ...
            log(string.Format(
                ...
                "[PullSub.Diagnostics] State={0} Started={1} Connected={2} Ready={3} CapturedAtUtc={4:O} Topics={5} QueueHandlerDiagnostics={6}",
                snapshot.State,
                snapshot.IsStarted,
