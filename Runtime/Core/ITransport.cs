...
namespace PullSub.Core
{
    public interface ITransport
    {
        ...
        Task EnqueueAsync(string topic, byte[] payload, MqttQualityOfServiceLevel qos, bool retain);
        Task SubscribeAsync(string topic, MqttQualityOfServiceLevel qos, CancellationToken cancellationToken);
