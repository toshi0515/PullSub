...
namespace UnityMqtt.V2.Core
{
    ...
    public sealed class MqttV2Credentials : IEquatable<MqttV2Credentials>
    {
        ...
        public MqttV2Credentials(string username = null, string password = null)
        {
        ...
        public bool Equals(MqttV2Credentials other)
        {
            if (ReferenceEquals(null, other))
                return false;
        ...
        public override bool Equals(object obj) => Equals(obj as MqttV2Credentials);
    ...
    public sealed class MqttV2TlsOptions : IEquatable<MqttV2TlsOptions>
    {
        public static MqttV2TlsOptions Disabled { get; } = new MqttV2TlsOptions(false);

        public MqttV2TlsOptions(
            bool enabled,
        ...
        public bool Equals(MqttV2TlsOptions other)
        {
            if (ReferenceEquals(null, other))
                return false;
        ...
        public override bool Equals(object obj) => Equals(obj as MqttV2TlsOptions);
    ...
    public sealed class MqttV2KeepAliveOptions : IEquatable<MqttV2KeepAliveOptions>
    {
        public const int DefaultSeconds = 15;
        public const int MinSeconds = 1;
        public const int MaxSeconds = 3600;

        public static MqttV2KeepAliveOptions Default { get; }
            = new MqttV2KeepAliveOptions(enabled: true, seconds: DefaultSeconds);

        public static MqttV2KeepAliveOptions Disabled { get; }
            = new MqttV2KeepAliveOptions(enabled: false);

        public MqttV2KeepAliveOptions(bool enabled, int seconds = DefaultSeconds)
        {
        ...
        public bool Equals(MqttV2KeepAliveOptions other)
        {
            if (ReferenceEquals(null, other))
                return false;
        ...
        public override bool Equals(object obj) => Equals(obj as MqttV2KeepAliveOptions);
    ...
    public sealed class MqttV2WillOptions : IEquatable<MqttV2WillOptions>
    {
        public static MqttV2WillOptions Disabled { get; } = new MqttV2WillOptions(false);

        public MqttV2WillOptions(
            bool enabled,
            string topic = null,
            ...
            bool retain = false)
        {
            if (enabled && !Enum.IsDefined(typeof(MqttQualityOfServiceLevel), qos))
            ...
            Qos = enabled ? qos : MqttQualityOfServiceLevel.AtMostOnce;
        ...
        public bool Equals(MqttV2WillOptions other)
        {
            if (ReferenceEquals(null, other))
                return false;
        ...
        public override bool Equals(object obj) => Equals(obj as MqttV2WillOptions);
    ...
    public sealed class MqttV2SubscriptionDefaults : IEquatable<MqttV2SubscriptionDefaults>
    {
        public static MqttV2SubscriptionDefaults Default { get; }
            = new MqttV2SubscriptionDefaults(MqttQualityOfServiceLevel.AtMostOnce);

        public MqttV2SubscriptionDefaults(MqttQualityOfServiceLevel subscribeQos)
        {
        ...
        public MqttQualityOfServiceLevel SubscribeQos { get; }

        public bool Equals(MqttV2SubscriptionDefaults other)
        {
            if (ReferenceEquals(null, other))
                return false;
        ...
        public override bool Equals(object obj) => Equals(obj as MqttV2SubscriptionDefaults);

        public override int GetHashCode() => (int)SubscribeQos;
    }

    public sealed class MqttV2ConnectionOptions : IEquatable<MqttV2ConnectionOptions>
    {
        public static MqttV2ConnectionOptions Default { get; } = new MqttV2ConnectionOptions();

        public MqttV2ConnectionOptions(
            MqttV2Credentials credentials = null,
            ...
            MqttV2TransportOptions transport = null)
        {
            ...
            Credentials = credentials ?? MqttV2Credentials.Anonymous;
            KeepAlive = keepAlive ?? MqttV2KeepAliveOptions.Default;
        ...
        public MqttV2KeepAliveOptions KeepAlive { get; }
